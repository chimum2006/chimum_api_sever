...
def decode_base64_image(b64_string):
    """Chuyển base64 -> ảnh PIL"""
    if ',' in b64_string:
        b64_string = b64_string.split(',')[1]  # bỏ phần 'data:image/...'
    img_data = base64.b64decode(b64_string)
    return Image.open(BytesIO(img_data))

def find_template_coords(big_img_pil, template_path):
    """Tìm vị trí của ảnh mẫu trong ảnh lớn"""
...
def find_position():
    ...
    try:
        ...
        img_pil = decode_base64_image(data['image_base64'])
